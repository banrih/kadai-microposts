...
ActiveRecord::Schema.define(version: 20171015115126) do
  ...
  create_table "favourites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "post_id"], name: "index_favourites_on_user_id_and_post_id", unique: true, using: :btree
  ...
  add_foreign_key "favourites", "microposts", column: "post_id"
